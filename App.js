...
export default function App() {
  ...
  <View style={s.root}>
    ...
    {playing && (
      ...
      >
        <Text style={s.pauseText}>II</Text>
      </TouchableOpacity>
    )}
    ...
    {gameState === "idle" && (
      <View style={s.overlay}>
        ...
        <TouchableOpacity style={s.button} onPress={startGame}>
          <Text style={s.buttonText}>Start Game</Text>
        </TouchableOpacity>
      </View>
    )}
...
const s = StyleSheet.create({
  ...
  panel: {
    alignItems: "center",
    backgroundColor: "rgba(222,216,149,0.95)",
    borderRadius: 10,
    paddingVertical: 20,
